...
//
static static eastl::string c_zoon      = "";
static static eastl::string top_zoon    = "";
static static eastl::string bottom_zoon = "";
static static eastl::string e_zoon      = "";
static static eastl::string w_zoon      = "";
static static eastl::string n_zoon      = "";
static static eastl::string s_zoon      = "";
//
//
