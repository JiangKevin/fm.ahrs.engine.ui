...
public:
    ...
    void BigCharUiQuate( float* befor_x, float* befor_y, float* befor_z, float* befor_w, int befor_count, float* after_x, float* after_y, float* after_z, float* after_w, int after_count );
